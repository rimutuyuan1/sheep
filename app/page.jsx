  ...
  return (
    <main className='bg-white dark:bg-zinc-900'>
      <div className='container px-6 lg:px-8 max-w-[1280px] pt-16 md:pt-20 lg:pt-36 pb-6'>
        <div className="inline-block text-3xl lg:text-5xl font-bold dark:text-white pt-12 pb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#9DCBEE] to-main ">Sean's secret world</div>
